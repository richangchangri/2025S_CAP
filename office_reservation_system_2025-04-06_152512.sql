...
--
-- Host: 192.168.1.173    Database: office_reservation_system
-- ------------------------------------------------------
...
(1,'brown@gmail.com','','2025-04-06 20:36:35');
...
(1,'Ruby Room','Small meeting room',8,'Tower A Lv.3',1,1,'available',NULL,NULL),
(2,'Grand Hall','Main auditorium',200,'Tower B Lv.1',2,2,'available',NULL,NULL),
(3,'Fitness Center','Gym with cardio machines',20,'Annex Lv.2',3,3,'under maintenance',NULL,NULL),
(4,'Food Court','Main dining area',100,'Main Campus Lv.1',4,4,'available',NULL,NULL),
(5,'Maker Lab','Workshop with tools',15,'Innovation Hub Lv.3',5,5,'available',NULL,NULL);
...
(1,'John Doe','john@example.com','hashed123','Admin','08123456789','2025-04-04 15:12:19','2025-04-04 15:15:26',NULL,'pending'),
(2,'Jane Smith','jane@example.com','hashed456','Facility Manager','08234567890','2025-04-04 15:12:19','2025-04-04 15:15:26',NULL,'pending'),
(3,'Bob Johnson','bob@example.com','hashed789','Regular User','08345678901','2025-04-04 15:12:19','2025-04-04 15:15:26',NULL,'pending'),
(4,'Alice Brown','alice@example.com','hashed101','Regular User','08456789012','2025-04-04 15:12:19','2025-04-04 15:15:26',NULL,'inactive'),
(5,'Charlie Lee','charlie@example.com','hashed112','Facility Manager','08567890123','2025-04-04 15:12:19','2025-04-04 15:15:26',NULL,NULL),
(6,'Michael','mmnaibaho.capstone@gmail.com','$2y$10$Y/RFIAVaJo/szFW/iAAWxOMco1DvWZMPqXOQRQn.ZXAGdk2xxWy9K','Admin',NULL,'2025-04-04 17:03:04','2025-04-04 17:03:04',1,'active');
...
--
-- Dumping routines for database 'office_reservation_system'
--
...
-- Dump completed on 2025-04-06 15:26:08
