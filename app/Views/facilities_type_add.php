    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Add Facilities Type</li>
            </ul><!-- /.breadcrumb -->
        </div>
                ...
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" name="formSubmit" id="formSubmit">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="hidden" id="facility_type_id" name="facility_type_id" value="" class="form-control">
                                <input type="text" id="name" name="name" placeholder="facilities type name" value="" class="form-control">
                            </div>
                        </div>
