                    ...
                    columnDefs: [
                        {
                            ...
                            render: function (data, type, row, meta) {
                                return `<div class="text-center">
                                    <a href="<?= base_url(); ?>feedback/detail/${row[0]}" class="btn btn-xs btn-default">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                    <a href="<?= base_url(); ?>feedback/edit/${row[0]}" class="btn btn-xs btn-warning">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="<?= base_url(); ?>feedback/delete/${row[0]}" class="btn btn-xs btn-danger delete-feedback" data-id="${row[0]}">
