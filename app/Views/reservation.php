...
<?= $this->section('content') ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
                    ...
                    columnDefs: [
                        {
                            ...
                            render: function (data, type, row, meta) {
                                ...
                                if (status === 'Approved') {
                                    actionHtml += `
                                    <a href="<?= base_url(); ?>reservation/feedback/${row[0]}" class="btn btn-xs btn-info" data-id="${row[0]}" title="Provide Feedback & Ratings">
            ...
            var completedTable = initializeTable('completedReservation', 'Completed');
