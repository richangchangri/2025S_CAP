    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Detail Facilities</li>
            </ul><!-- /.breadcrumb -->
        </div>
                ...
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" name="formSubmit" id="formSubmit">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                            <input type="text" id="location" name="location" placeholder="Text Field" class="form-control" value="<?= esc($facility['location']); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label>
                                    <input name="status" class="ace ace-switch ace-switch-5" <?php if($facility['status'] == "active")  echo "checked"; ?> type="checkbox" value="active">
                                    <span class="lbl"></span>
                                </label>          
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <span class="help-inline col-xs-12 col-sm-7">
                                    <span class="middle">Leave blank if you don't change password </span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                &nbsp; &nbsp; &nbsp;
                                <a class="btn" type="reset" href="<?= base_url('facilities'); ?>">
